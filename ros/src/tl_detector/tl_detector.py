...
class TLDetector(object):
    def __init__(self):
        ...
        self.pose = None
        self.waypoints = None
        self.waypoints_2d = None       # Fot get closest waypoint
        self.waypoint_tree = None      # Fot get closest waypoint
        self.camera_image = None       # Image from camera
        self.lights = []
    ...
    def waypoints_cb(self, waypoints):
        ...
        # Same function in waypoint_updater: waypoints_cb
    ...
    def process_traffic_lights(self):
        ...
        """
        closest_light = None
        line_wp_idx = None    # line way_point index
        ...
        if closest_light:
            ...
            #rospy.loginfo("Closet ligt state %d" %state) # for debug
