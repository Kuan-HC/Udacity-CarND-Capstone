...
class WaypointUpdater(object):
    def __init__(self):
        ...
        rospy.Subscriber('/traffic_waypoint', Int32, self.traffic_cb)  # Topic from node tl_detector 
    ...
    def get_closest_waypoint_idx(self):
        ...
        # val > 0 means this closest_coord is behind vehicle
        if val > 0:
            closest_coord = (closest_idx + 1) % len(self.waypoints_2d)
    ...
    '''
    generate_lane(self)
    Take waypoints and update their velocity
    if the stop line is within the range: farthest_idx 
    '''
    ...
    def decelerate_waypoints(self, waypoints, closest_idx):
        ...
        for i, wp in enumerate(waypoints):
            ...
            stop_idx = max(self.stopline_wp_idx - closest_idx - 2, 0) # -2 for make the point in front of the car
    ...
    def pose_cb(self, msg):
        # TODO: Implement
        self.pose = msg                   # store pose in the object
