...
class DBWNode(object):
    def __init__(self):
        ...
        self.throttle_pub = rospy.Publisher('/vehicle/throttle_cmd', ThrottleCmd, queue_size=1)   # this value should in range [0,1]
    ...
    def loop(self):
        rate = rospy.Rate(50) # Must be 50Hz, Do not change this 
